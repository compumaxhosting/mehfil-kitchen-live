            ...
            <div className='bg-[#1a3c34] text-white py-5 px-6 md:px-10 lg:px-20'>
                <div className='max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4'>
                    ...
                    <div className='flex flex-row gap-4 order-1 md:order-2'>
                        ...
                        {/* Twitter/X */}
                        <a href="#" target="_blank" rel="noopener noreferrer" className='flex items-center justify-center w-10 h-10 rounded-full bg-white bg-opacity-15 hover:bg-[#1a3c34] transition-all duration-300'>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='text-white'>
                    ...
                    <p className='order-2 md:order-1 text-sm mb-4'>© 2025 Mehfil Kitchen. All Rights Reserved.</p>
                </div>
            </div>
        </section><BottomMenu /></>
    )
